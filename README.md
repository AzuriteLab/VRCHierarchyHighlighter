...
このエディタ拡張を導入することによって、
間違った階層にオブジェクトを突っ込むリスクを下げたり、オブジェクトにちゃんとVRCPhysBoneが適用されているのか、
...
2026.07.31.0
    * 描画の最適化を行いました
      * 描画負荷が減ったほか、アイコンホバー時のクローズボタンの描画が爆速になりました
    * クローズボタントグルでオブジェクトの可視状態の他にEditorOnly/Untaggedも同時に変更するようにしました
    * ModularAvatarに対応しました
